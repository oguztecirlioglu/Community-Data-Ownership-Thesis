...
DOCKER_SOCK="${DOCKER_SOCK}" docker compose -f ./compose/docker-compose.yaml -f ./compose/docker-compose-org2.yaml up -d 2>&1
...
configtxgen -profile TwoOrgOneOrdGenesis -outputBlock ./channel-artifacts/communitydatachannel.block -channelID communitydatachannel -configPath ./configFiles
...
echoln "Org2 joined to channel successfully \n"
...
echoln "Chaincode installed and approved for Org1"
...
echoln "Chaincode installed and approved for Org2"
